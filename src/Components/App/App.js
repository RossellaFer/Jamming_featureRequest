...
//and sets the state of the playlist name to this value
  ...
  launchPreview(currentTrack) {
    let previewArray = [];
    this.state.searchResults.map(track => {
      previewArray.push(track.preview);
    });
    console.log(previewArray);
    console.log(currentTrack);
    let currentTrackIndex = previewArray.indexOf(currentTrack.preview);
    console.log(currentTrackIndex);
    // window.open(currentTrackIndex);
  }
      ...
      <div>
        ...
        {/*This displays the search results and allows the user to add to the playlist*/}
            <SearchResults searchResults={this.state.searchResults}
                           onAdd={this.addTrack}
                           launchPreview={this.launchPreview}
                           />
